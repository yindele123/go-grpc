...
import (
	...
	"project/goods_web/initialize"
	"project/goods_web/utils/register"
	validator2 "project/goods_web/validator"
	"syscall"
)
...
func main() {
	...
	rerr:=consulRegister.Register(global.ServerConfig.Host, global.ServerConfig.Port, global.ServerConfig.Name, []string{"xindele", "yindele123","goods-web"}, serviceId)
	if rerr != nil {
