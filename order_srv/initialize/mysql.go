...
func InitMysql() {
	...
	/*dsn := "root:root@tcp(192.168.226.108:3306)/order_srv?charset=utf8mb4&parseTime=True&loc=Local"*/
	...
	//db.AutoMigrate(&model.Ordergoods{},&model.Orderinfo{},&model.Shoppingcart{})
	//MysqlDb
	global.MysqlDb=db
}
