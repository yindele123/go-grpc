...
func InitMysql() {
	...
	/*dsn := "root:root@tcp(192.168.226.108:3306)/userop_srv?charset=utf8mb4&parseTime=True&loc=Local"*/
	...
	//db.AutoMigrate(&model.Address{},&model.Leavingmessages{},&model.Userfav{})
	//MysqlDb
	global.MysqlDb=db
}
