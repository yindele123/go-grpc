...
import (
	...
	"project/userop_web/initialize"
	"project/userop_web/utils/register"
	validator2 "project/userop_web/validator"
	"syscall"
)
...
func main() {
	...
	rerr:=consulRegister.Register(global.ServerConfig.Host, global.ServerConfig.Port, global.ServerConfig.Name, []string{"xindele", "yindele123","userop_web"}, serviceId)
	if rerr != nil {
